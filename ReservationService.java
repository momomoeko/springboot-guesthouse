...
public class ReservationService {
	...
	// 指定されたユーザーに紐づく予約を作成日時が新しい順に並び替え、ページングされた状態で取得する
	...
	public boolean isCheckinBeforeCheckout(LocalDate chekinDate, LocalDate checkoutDate) {
		return chekinDate.isBefore(checkoutDate);
	}
